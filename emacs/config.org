...
#+begin_src emacs-lisp
(defun my-eglot-strict-env-mlir (&optional _interactive)
...
#+begin_src emacs-lisp
(let ((workspaces-script (expand-file-name "workspaces.el" (concat user-emacs-directory "var/"))))
  (unless (file-exists-p workspaces-script)
    ;; Force create the enclosing directory if it doesn't exist yet
    (make-directory (file-name-directory workspaces-script) t)
    ;; Write file with raw append permissions to clear buffer limits
    (with-temp-file workspaces-script
      (insert ";;; workspaces.el --- Workspace Mappings -*- lexical-binding: t; -*-\n\n")
      (insert ";; (setq my-personal-workspaces\n")
      (insert ";;       '((\"project-alpha\" . \"/home/user/workspaces/project-alpha/\")\n")
      (insert ";;         (\"project-beta\"  . \"/home/user/workspaces/project-beta/\")))\n\n")))

  ;; Load the mapping file
  (load workspaces-script 'noerror))
#+end_src
