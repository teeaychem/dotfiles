...
(use-package treesit-auto
  ...
  (let ((llvm-recipe
        ...
        (tablegen-recipe
         (make-treesit-auto-recipe
          :lang 'tablegen
          :ts-mode 'tablegen-ts-mode
          :url "https://github.com/tree-sitter-grammars/tree-sitter-tablegen"
          :ext "\\.td\\'")))

    (add-to-list 'treesit-auto-recipe-list llvm-recipe)
    (add-to-list 'treesit-auto-recipe-list tablegen-recipe))


  (add-to-list 'treesit-auto-langs 'llvm)
  (add-to-list 'treesit-auto-langs 'tablegen)
