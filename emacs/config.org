...
(use-package treesit-auto
  ...
  (dolist (recipe treesit-auto-recipe-list)
    (let ((orig-mode (treesit-auto-recipe-remap recipe))
  ...
  (defun my/install-all-grammars ()
    "Interactively compile everything scraped from the treesit-auto database."
    (interactive)
    (dolist (source treesit-language-source-alist)
      (message "Compiling parser for %s..." (car source))
      (ignore-errors (treesit-install-language-grammar (car source)))
