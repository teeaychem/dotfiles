...
(use-package lean4-mode
  ...
  :straight (lean4-mode :type git :host github :repo "bustercopley/lean4-mode" :files ("*.el" "data"))
  :mode "\\.lean\\'")
#+end_src
** lua
