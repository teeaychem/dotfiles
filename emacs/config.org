...
(use-package emacs
  ...
  (context-menu-functions (delete 'context-menu-undo context-menu-functions)))
#+end_src
...
(defun my-silent-dabbrev-search (orig-fun &rest args)
  "Silence the 'Scanning for dabbrevs' message during search."
  (let ((inhibit-message t)
        (message-log-max nil))
    (apply orig-fun args)))

(advice-add 'dabbrev--find-expansion :around #'my-silent-dabbrev-search)
#+end_src
