...
(with-eval-after-load 'exec-path-from-shell
  (eval-and-compile
    (defun repos-load-path (load-path)
      (concat (getenv "REPOS_DIR") load-path)))

    (use-package llvm-mode
      :load-path (lambda () (list (repos-load-path "/llvm/llvm/utils/emacs")))
      :mode "\\.ll\\'"
      :commands llvm-mode)
    ...
    (use-package mlir-mode
      :load-path (lambda () (list (repos-load-path "/llvm/mlir/utils/emacs")))
      :mode "\\.mlir\\'"
      :commands mlir-mode)
